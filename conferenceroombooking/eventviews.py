...
def MonthlyCalendar(request):
	...
	return render(request, 'MonthlyCalendar.html', {'page_name':'Monthly View', 'today':today, 
...
def showweekcalendar(request,year='2000',month='01',day='01'):
	...
	return render(request, 'WeeklyCalendar.html', {'page_name':'Weekly View', 'calendar': result['calendar'], 
...
def showdaycalendar(request,year='2000',month='01',day='01'):
	...
	return render(request, 'DayCalendar.html', {'page_name':'Daily View', 'calendar': result['calendar'], 
...
def showcalendar(request):
	try:
		...
		return render(request, 'MonthlyCalendar.html', {'page_name':'Monthly View', 'today':CURRENT_DATE.date(), 
								'calendar': result['calendar'], 'headers': result['headers'], 
								'monthyear': result['monthyear'], 'monthdata': result['monthdata']},
								)
	except:
		return render(request, 'MonthlyCalendar.html', {'page_name':'Monthly View',
