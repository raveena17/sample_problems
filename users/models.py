...
class UserProfile(models.Model):
    ...
    address_contact = models.ForeignKey(Address,
                    related_name = "%(app_label)s_%(class)s_contact_address",
                    verbose_name = _('contact address'), null = True)
    address_permanent = models.ForeignKey(Address,
                    related_name = "%(app_label)s_%(class)s_permanent_address",
    ...
    pf_no = models.CharField(_('PF number'), max_length = 16,
                                                    blank = True, null = True)
    passport_no = models.CharField(_('PUserProfileassport number'),
    ...
    reporting_senior_name = models.ForeignKey(User, blank=True, null=True, verbose_name = _('reporting_senior_name'), related_name = "%(app_label)s_%(class)s_reporting_senior_name")
