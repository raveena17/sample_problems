...
#        print query
    ...
    return render(request, 'phase.html', {'phase_details': phase_details, 'json_msg': json_msg})
...
def delete_phase(request):
    ...
    return render(request, 'phase.html', {'phase_details': phase_details, 'msg': msg, 'bg_color': bg_color, 'color': color},)
...
def delete_cost(request):
    ...
    return render(request, 'cost.html', {'cost_list': cost_list, 'msg1': msg1, 'bgcolor': bgcolor, 'color': color, },)
